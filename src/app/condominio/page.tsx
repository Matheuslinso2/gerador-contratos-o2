...
export const metadata: Metadata = {
  title: "Seguro Condomínio O2 Seguros — Ficha Online",
  description: "Ficha online para dar entrada na cotação de Seguro Condomínio junto à O2 Seguros.",
  openGraph: {
    title: "Seguro Condomínio O2 Seguros — Ficha Online",
    description: "Ficha online para dar entrada na cotação de Seguro Condomínio junto à O2 Seguros.",
  ...
  return (
    <>
      ...
      <main className="mx-auto flex w-full max-w-2xl flex-1 flex-col gap-6 p-6 sm:p-8">
        {user && <LinkPublicoCompartilhavel path="/condominio" />}
        <div className="flex flex-col items-center gap-4 text-center">
          ...
          <div>
            ...
            <h1 className="mt-2 text-xl font-semibold" style={{ color: "#01192e" }}>
              Ficha Online — Condomínio
            </h1>
            <p className="mt-1 text-sm text-gray-600">Preencha os dados abaixo para seguirmos com a cotação do seguro condomínio.</p>
          </div>
        </div>
