...
export const metadata: Metadata = {
  title: "RCP O2 Seguros — Ficha Online",
  description: "Ficha online para dar entrada na cotação de Seguro de Responsabilidade Civil Profissional (RCP) junto à O2 Seguros.",
  openGraph: {
    title: "RCP O2 Seguros — Ficha Online",
    description: "Ficha online para dar entrada na cotação de Seguro de Responsabilidade Civil Profissional (RCP) junto à O2 Seguros.",
  ...
  return (
    <>
      ...
      <main className="mx-auto flex w-full max-w-2xl flex-1 flex-col gap-6 p-6 sm:p-8">
        {user && <LinkPublicoCompartilhavel path="/rcp" />}
        <div className="flex flex-col items-center gap-4 text-center">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-gray-600">Preencha os dados abaixo para seguirmos com a cotação do seguro RCP.</p>
          </div>
        </div>
