...
import SeguroIncendioForm from "./SeguroIncendioForm";
...
export const metadata: Metadata = {
  title: "Seguro Incêndio O2 Seguros — Ficha Online",
  description: "Ficha online para dar entrada na cotação de seguro incêndio (residencial, empresarial ou imobiliário) junto à O2 Seguros.",
  openGraph: {
    title: "Seguro Incêndio O2 Seguros — Ficha Online",
    description: "Ficha online para dar entrada na cotação de seguro incêndio (residencial, empresarial ou imobiliário) junto à O2 Seguros.",
...
export default async function SeguroIncendioPage() {
  ...
  return (
    <>
      ...
      <main className="mx-auto flex w-full max-w-2xl flex-1 flex-col gap-6 p-6 sm:p-8">
        {user && <LinkPublicoCompartilhavel path="/seguro-incendio" />}
