...
0. LEITURA BRUTA ("leitura_bruta") — SEMPRE preencha primeiro, antes de qualquer outro campo. Se o panorama vier como TEXTO, escreva 1 frase curta confirmando os dados recebidos. Se vier como IMAGEM OU PDF, faça uma transcrição cuidadosa, seguradora por seguradora, ANTES de decidir qualquer taxa ou multiplicador (um PDF pode ter várias páginas — transcreva página por página se precisar):
   ...
   b) FORMATO COMUM destes painéis: plano Básico e plano Completo de uma mesma seguradora são DUAS grades de multiplicador INDEPENDENTES lado a lado (cada uma com suas próprias colunas, ex: Básico em 18x/24x/30x e Completo em 18x/20x/24x/30x) — uma seguradora pré-aprovada pode ter o LMI efetivamente aprovado em multiplicadores diferentes no Básico e no Completo, inclusive mais de um multiplicador preenchido em cada plano. Trate cada grade (Básico e Completo) separadamente, mesmo sendo da mesma seguradora.
